...
IEEE_8023dj = COMParams(
    106.25, 0.01, 4, 32, 2e-4, 0.004, 0.95, 0.413, 0.413, 0.45, 50,
    0.02, 33, 6.0e-9, 0.01,
    ...
    0.58, np.array([0.0]), np.array([0.85]), np.array([-0.7] * 5 + [1.0] + [-0.7] * 10),
    np.array([0.7] * 5 + [1.0] + [0.7] * 10), 5,
    np.array([50.]), [4.0e-5, 9.0e-5, 1.1e-4], [3.0e-5], [4.0e-5], [0.13, 0.15, 0.14], [87.5, 92.5], [33, 1.8],
    5.0e-4, 8.9e-4, 2.0e-4, 6.141e-3)
